...
import { AgentWorkflow, WorkflowCallbacks } from './agentWorkflow';
import { WorkflowPlan } from './taskManager';
...
export class ChatPanelProvider implements vscode.WebviewViewProvider {
    ...
    constructor(
        ...
        this.workflow = new AgentWorkflow(ollama, diffManager);
     ...
     */
    private setupWorkflowCallbacks(): void {
